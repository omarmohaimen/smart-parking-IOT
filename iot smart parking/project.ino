...
const char *ssid =  "DESKTOP-SAKI3Q5 6383";     // Enter your WiFi Name
const char *pass =  "3%923Mh2"; // Enter your WiFi Password

#define MQTT_SERV "io.adafruit.com"
#define MQTT_PORT 1883
#define MQTT_NAME "Khaled_"
#define MQTT_PASS "aio_SGNM527ylXlK1Lqo6mDOU6pfccAt"
WiFiUDP ntpUDP;
...
void setup() {
  ...
  timeClient.begin(); 
  myservo.attach(D4);      // servo pin to D6   exit servo 
  myservos.attach(D5);       // servo pin to D5 enter servo 
...
void loop() {
 ...
 s3 = !digitalRead(slot3);
  ...
  if (s1 == 1 && s1_occupied == false) {                     
        ...
        count=  count+1;
      //  Serial.print (led,1);               // the led behind the sensor 
        EntryTimeSlot1 =  h +" :" + m;
